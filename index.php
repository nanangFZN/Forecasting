                            ...
                            switch ($page) {
                                case 'dashboard':
                                    ...
                                    case 'user':
                                        ...
                                        break;
                                        case 'product':
                                            include 'module/product/create.php';
                                            break;
                                            case 'cartsData';
                                                            ...
                                                            case 'ordersData';
                                                                ...
                                                                case 'paymentsData';
                                                                    ...
                                                                    case 'usersData';
                                                                     ...
                                                                     break;
                                                                        case 'editProduct';
                                                                            include 'module/product/edit.php';
                                                                            break;
                                                                            case 'forecastData':
                                                                                include 'module/forecast/index.php';
                                                                                break;
                                                                                case 'reportsData':
                                                                                    include 'module/report/index.php';
                                                                                    break;
                                                                                    case 'entrySelling':
                                                                                        include 'module/order/entry_selling.php';
                                                                                        break;
                                                                                        case 'entryProduct':
                                                                                            include 'module/cake/create.php';
                                                                                            break;
                                                                                            case 'cakeData':
                                                                                                include 'module/cake/index.php';
                                                                                                break;
                                                             }   
                        }
                    ?>
  ...
  datasets: [{
    ...
    data: [
        ...
        include 'action/connection.php';
            $qry=mysqli_query($connection,"SELECT kategori FROM cake WHERE kategori='reguler'");
            $resF = $qry->num_rows;
            echo $resF;
        ?>,
         <?php
        include 'action/connection.php';
            $qry=mysqli_query($connection,"SELECT kategori FROM cake WHERE kategori='mini'");
            $resF = $qry->num_rows;
            echo $resF;
        ?>
    ],
